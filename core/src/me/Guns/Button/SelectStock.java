...
public class SelectStock extends GunsButton{

	//Constructor
	public SelectStock(float x, float y, StudiumComponent parent) 
	{
		super(x, y, "", parent);
	...
	public void draw(SpriteBatch batch) 
	{
		...
		if((CreateScreen.partView && CreateScreen.selectedPart == 3) || 
	...
	{
		//3 = Stock
		if(CreateScreen.prototype.getTrigger().isStockAllowed())
			CreateScreen.selectedPart = 3;
	}
	public void rightClick()
	{
		CreateScreen.prototype.setStock(-1);
